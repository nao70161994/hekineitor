...
python -m ruff format --diff app.py engine routes services scripts tests analytics.py audit.py matrix_service.py storage.py work_utils.py check_works_links.py config.py fetch_kindle_asins.py restore_matrix.py run_coverage.py
