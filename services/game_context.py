...
def build(
    *,
    ...
    def confidence_snapshot(engine_arg, answers):
        ...
        """
        return question_selection.raw_confidence_snapshot(
            engine_arg,
            answers,
            exclude_ids=session.get('exclude_ids', []),
        )
    ...
    question_flow = context.game_question_flow(
        ...
        append_confidence_history=question_selection.append_confidence_history,
        stopping_assessment=question_selection.stopping_assessment,
