...
DOMAIN_PRIORS = [
    ...
    # 抽象推論追加(105-134): 日常・感情・距離感から複数性癖を絞り込む
    (127,105,0.85),(126,105,0.75),(10,105,0.70),(108,105,0.65),(92,105,0.55),
    (102,106,0.85),(91,106,0.75),(126,106,0.65),(115,106,0.60),(117,106,0.55),
    (85,107,0.75),(118,107,0.70),(103,107,0.75),(105,107,0.65),(92,107,0.60),
    (126,108,0.85),(17,108,0.75),(111,108,0.70),(127,108,0.65),(65,108,0.60),
    (126,109,0.80),(127,109,0.75),(125,109,0.60),(114,109,0.55),(108,109,0.55),
    (116,110,0.80),(118,110,0.65),(101,110,0.60),(36,110,0.55),(57,110,0.50),
    (120,111,0.85),(31,111,0.65),(35,111,0.70),(125,111,0.60),(85,111,0.55),
    (85,112,0.80),(103,112,0.75),(118,112,0.70),(127,112,0.65),(92,112,0.60),
    (27,113,0.65),(86,113,0.70),(3,113,0.55),(112,113,0.75),(125,113,0.60),
    (105,114,0.75),(123,114,0.65),(124,114,0.65),(103,114,0.65),(85,114,0.60),
    (108,115,0.75),(126,115,0.70),(111,115,0.65),(17,115,0.55),(125,115,0.55),
    (125,116,0.80),(123,116,0.70),(75,116,0.65),(108,116,0.60),(101,116,0.55),
    (102,117,0.75),(115,117,0.70),(120,117,0.80),(91,117,0.65),(44,117,0.55),
    (116,118,0.85),(104,118,0.75),(80,118,0.65),(48,118,0.60),(127,118,0.55),
    (126,119,0.85),(108,119,0.70),(127,119,0.75),(113,119,0.60),(65,119,0.55),
    (120,120,0.80),(31,120,0.65),(35,120,0.60),(125,120,0.75),(81,120,0.55),
    (127,121,0.80),(91,121,0.75),(126,121,0.70),(65,121,0.60),(17,121,0.55),
    (62,122,0.65),(48,122,0.60),(73,122,0.55),(116,122,0.55),(127,122,0.50),
    (124,123,0.75),(105,123,0.75),(123,123,0.80),(126,123,0.65),(117,123,0.55),
    (125,124,0.80),(120,124,0.85),(124,124,0.70),(123,124,0.65),(37,124,0.55),
    (91,125,0.80),(126,125,0.85),(102,125,0.75),(111,125,0.70),(115,125,0.60),
    (126,126,0.90),(112,126,0.70),(3,126,0.60),(27,126,0.65),(127,126,0.75),
    (127,127,0.85),(113,127,0.75),(58,127,0.65),(108,127,0.70),(101,127,0.60),
    (125,128,0.75),(120,128,0.80),(86,128,0.65),(123,128,0.60),(39,128,0.55),
    (102,129,0.80),(126,129,0.75),(115,129,0.70),(91,129,0.65),(117,129,0.60),
    (127,130,0.85),(126,130,0.75),(82,130,0.65),(74,130,0.55),(108,130,0.60),
    (111,131,0.85),(120,131,0.75),(31,131,0.65),(39,131,0.70),(125,131,0.60),
    (115,132,0.75),(90,132,0.70),(126,132,0.65),(48,132,0.55),(121,132,0.60),
    (118,133,0.85),(103,133,0.80),(105,133,0.75),(85,133,0.70),(37,133,0.65),
    (127,134,0.75),(84,134,0.70),(116,134,0.65),(92,134,0.60),(99,134,0.55),
]

# 関連性癖マップ（包含・重複関係）
# Attribute/world/tone/value abstract questions added for category balance (135-142).
DOMAIN_PRIORS.extend([
    # Q135: 非現実感・超常・世界観
    (21,135,0.85),(29,135,0.85),(43,135,0.8),(48,135,0.8),(57,135,0.75),
    (69,135,0.85),(76,135,0.75),(80,135,0.75),(90,135,0.8),(110,135,0.75),
    # Q136: 服装・制服・整った身なり
    (27,136,0.75),(42,136,0.7),(71,136,0.75),(87,136,0.75),(123,136,0.9),(124,136,0.9),(125,136,0.85),
    # Q137: 静かな温度感
    (31,137,0.75),(90,137,0.75),(105,137,0.7),(108,137,0.75),(115,137,0.75),(120,137,0.8),(125,137,0.75),
    # Q138: 無機質・人形的・機械的
    (28,138,0.9),(34,138,0.75),(66,138,0.7),(80,138,0.75),(122,138,0.9),(123,138,0.75),(124,138,0.75),
    # Q139: 閉じた空間・特別な場所
    (32,139,0.75),(50,139,0.7),(57,139,0.8),(80,139,0.75),(87,139,0.7),(96,139,0.75),(99,139,0.7),(124,139,0.8),
    # Q140: ルール・役割・契約
    (18,140,0.75),(27,140,0.85),(34,140,0.75),(83,140,0.7),(86,140,0.85),(97,140,0.75),(104,140,0.8),(112,140,0.8),(125,140,0.75),
    # Q141: 清潔感・整った雰囲気
    (31,141,0.75),(71,141,0.8),(87,141,0.7),(105,141,0.75),(120,141,0.75),(123,141,0.85),(124,141,0.85),(125,141,0.8),
    # Q142: 観察する/される関係
    (85,142,0.75),(103,142,0.8),(105,142,0.85),(118,142,0.8),(123,142,0.8),(124,142,0.75),
])
...
FETISH_PRIOR_WEIGHTS = {
    ...
    121: 1.3, 122: 1.0,
    # 一言属性追加（123-127）
    123: 1.5, 124: 1.5, 125: 1.5, 126: 1.0, 127: 1.0,
}
