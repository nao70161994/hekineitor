...
class TestEngineLearningRegression(unittest.TestCase):
    ...
    def test_positive_learning_matrix_delta_snapshot(self):
        ...
        self.assert_cells(engine, {
            0: {8: (19.788635156664895, 20.788635156664895), 9: (2.0, 4.949946893255444), 10: (2.0, 4.0)},
            1: {8: (2.0, 4.236590546999469), 9: (19.284984067976634, 20.284984067976634), 10: (2.0, 4.0)},
        })
    ...
    def test_near_miss_learning_matrix_delta_snapshot(self):
        ...
        self.assert_cells(engine, {
            0: {8: (19.276022304832715, 20.276022304832715), 9: (2.0, 4.332481412639405), 10: (2.0, 4.0)},
