...
class TestEngineHelperDependencies(unittest.TestCase):
    ...
    def test_top_level_moved_shims_alias_package_modules(self):
        aliases = {
            ...
            'engine_db': 'engine.db',
            'engine_inference': 'engine.inference',
            'engine_learning': 'engine.learning',
            'engine_mutations': 'engine.mutations',
            'engine_persistence': 'engine.persistence',
            'engine_question_selection': 'engine.question_selection',
