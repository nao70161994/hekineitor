...
def _admin_context():
    ...
    return admin_context_service.build(
        ...
        list_compound_works=engine.list_compound_work_rows,
        set_compound_works=engine.set_compound_work_rows,
        delete_compound_works=engine.delete_compound_work_rows,
